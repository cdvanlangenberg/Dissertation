...
\usepackage{amsmath}
\usepackage{natbib,apalike, float} 
\usepackage{undertilde}
\usepackage{enumerate}
\usepackage{graphicx}
\usepackage{framed}
\usepackage{subcaption} %multiple figures with captions
\usepackage{multirow}
\usepackage{setspace}
\usepackage[font=doublespacing]{caption} % caption double space
\usepackage[bottom]{footmisc} %footnote page bottom
\usepackage{bm}
...
\begin{dedication}
In memory of my father, Donald Anthony Vanlangenberg
\end{dedication}
...
%%------------------------------------------------------------------%%
\chapter{Global Data Generation}
